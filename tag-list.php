...
load_plugin_textdomain('tag_list');
add_shortcode( 'tag-list',  'get_iworks_tag_list' );
add_action('wp_head', 'get_iworks_tag_list_css');

#
# get_options()
#

function iworks_tag_list_get_options()
{
...
#
# get_iworks_tag_list_css()
#
function get_iworks_tag_list_css()
{
    $options = iworks_tag_list_get_options();
