...
if ( class_exists( 'iworks_tag_list_github' ) ) {
	return;
}

class iworks_tag_list_github {
	 ...
	 * @since 1.0.0
	 */
	private string $repository = 'iworks/tag-list';
	/**
	 * Plugin base name
	 *
	 * @since 1.0.0
	 */
	private string $basename = 'tag-list';
	/**
	 * Plugin file name
	 *
	 * @since 1.0.0
	 */
	private string $plugin_file = 'tag-list.php';
	/**
	 * Github Response
	 *
	 * @since 1.0.0
	...
	public function __construct() {
		 ...
		 * WordPress Hooks
		 */
		add_action( 'init', array( $this, 'action_init_load_textdomain' ) );
	...
	public function action_init_load_textdomain() {
		...
		load_plugin_textdomain( 'tag-list', false, $dir );
	}
	...
	public function plugin_popup( $result, $action, $args ) {
		...
		$details = get_plugin_data( dirname( $this->base ) . '/tag-list.php' );
